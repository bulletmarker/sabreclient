...
@XmlRootElement(name = "EndTransactionRQ", namespace = "http://webservices.sabre.com/sabreXML/2011/10")
public class EndTransactionRQ {

    @XmlElement(name = "EndTransaction", namespace = "http://webservices.sabre.com/sabreXML/2011/10")
    ...
    public static class EndTransaction {
        ...
        public static class Email {
            ...
            @XmlElement(namespace = "http://webservices.sabre.com/sabreXML/2011/10")
            protected EndTransactionRQ.EndTransaction.Email.ETicket eTicket;
            @XmlElement(name = "Invoice", namespace = "http://webservices.sabre.com/sabreXML/2011/10")
            protected EndTransactionRQ.EndTransaction.Email.Invoice invoice;
            @XmlElement(name = "Itinerary", namespace = "http://webservices.sabre.com/sabreXML/2011/10")
            ...
            public static class ETicket {
                ...
                @XmlElement(name = "PDF", namespace = "http://webservices.sabre.com/sabreXML/2011/10")
