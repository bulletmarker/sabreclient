...
@XmlRootElement(name = "EndTransactionRS", namespace = "http://webservices.sabre.com/sabreXML/2011/10")
public class EndTransactionRS {
    ...
    @XmlElement(name = "ItineraryRef", namespace = "http://webservices.sabre.com/sabreXML/2011/10")
