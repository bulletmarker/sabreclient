package com.itsum.sabre.client.dto.common;
    ...
    extends Results
{
    ...
    @XmlElement(name = "Success",namespace="http://services.sabre.com/STL/v01")
    protected List<ProblemInformation> success;
    @XmlElement(name = "Error",namespace="http://services.sabre.com/STL/v01")
    protected List<ProblemInformation> error;
    @XmlElement(name = "Warning",namespace="http://services.sabre.com/STL/v01")
